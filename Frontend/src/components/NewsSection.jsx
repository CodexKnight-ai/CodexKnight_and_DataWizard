  ...
  return (
    <>
      <article class="font-gtaDescriptionText w-[24em] h-[21em] relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-3 pb-6 pt-40 max-w-sm mx-auto ">
        ...
        <div class="z-10 mt-2 gap-y-1 overflow-x-hidden text-sm leading-6 text-gray-300">
      ...
      <div className="w-full h-full bg-dblue rounded-[1.2em]">
        <article class="font-gtaDescriptionText overflow-auto w-full h-full relative isolate flex flex-col justify-end  rounded-[1.2em] px-5 pb-10 pt-40  ">
          <img
            ...
            class="absolute inset-0 h-full w-full object-cover overflow-hidden"
          />
          <div class="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/40"></div>
          <h2 class="z-10 mt-3 text-5xl font-bold text-white">
            Wo to mar gaya
          </h2>
          <div class="z-10 mt-5 ml-[3px] gap-y-1 overflow-x-hidden text-md leading-6 text-gray-300">
            Wo mar gaya kyoki kya kare use kisi ne mar dala ab isme ham kya kare
          </div>
        </article>
      </div>
      ...
      <div className="w-full h-[10em] bg-white shadow-xl rounded-[1.2em] p-[10px]">
        <article class="font-gtaDescriptionText  w-full h-full relative isolate flex justify-between  rounded-[1.2em]  ">
          <div className="w-[20%] overflow-hidden">
            <img
              src="./newsBackground.jpg"
              class="rounded-[0.8em] absolute inset-0 h-full w-[8.5rem] object-cover overflow-hidden"
            />
          </div>
          <div className="w-[70%] h-full">
            <h2 class="mt-3 text-2xl font-bold text-blackish">
              Wo to mar gaya
            </h2>
            <div class="mt-5 ml-[3px] gap-y-1 overflow-x-hidden text-md leading-6 text-blackish">
              Wo mar gaya kyoki kya kare use kisi ne mar dala ab isme ham kya
              kare
            </div>
          </div>
        </article>
